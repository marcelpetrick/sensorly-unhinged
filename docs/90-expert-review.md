...
| 8 | High / mechanical | B's divider at y=33.5 overlaps the full-width body ending at y=34; the USB aperture is centred on the PCB plane, covering only half the connector height. | Place the divider inside the actual neck and centre the USB opening on the connector; add geometry checks. |
